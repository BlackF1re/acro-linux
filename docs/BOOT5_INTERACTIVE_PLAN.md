...
`/home/paul/xperia/build/hikari-artifacts-g7-tty/hikari-boot5-interactive-tty.elf`:
`11,970,642` bytes, SHA-256
`d977bcc2c2bea3675e80c688b546712fcef6f00b3f4a19c165c5923047080176`.
...
```sh
fastboot flash boot /home/paul/xperia/build/hikari-artifacts-g7-tty/hikari-boot5-interactive-tty.elf
fastboot reboot
```
