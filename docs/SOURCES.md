...
| OpenSEMC Fuji USB BSP | `board-semc_fuji.c`, `devices-msm8x60.c`, `charger-fuji_hikari.c` and `include/linux/mfd/pm8xxx/pm8901.h` in [OpenSEMC MSM8x60](https://github.com/OpenSEMC/android_kernel_sony_msm8x60/tree/c4784b04c08d30f799b8b14b597aeb2124d2e6e1), branch `kk_chocolate_rmfx`, rechecked 2026-09-11 | HSUSB at `0x12500000`; PM8058 L6 3.05 V and L7 1.8 V; active-low ID on PM8058 GPIO30 with 1.5 kOhm/S3 pull-up; active-low VBUS detect on PM8058 MPP10; PM8901 second SSBI at `0x00c00000`, IRQ TLMM91, four MPPs; OTG source order BQ24160 OTG lock -> PM8901 MPP1 external 5 V -> NCP373 enable TLMM28, with active-low fault TLMM104. | `HISTORICAL_SOURCE`; exact board wiring and sequencing evidence used by the local dual-role DT and charger guard. Target-Linux OTG operation remains unverified. |
